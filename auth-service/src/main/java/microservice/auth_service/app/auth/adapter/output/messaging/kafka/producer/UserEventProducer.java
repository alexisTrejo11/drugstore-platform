package microservice.auth_service.app.auth.adapter.output.messaging.kafka.producer;
...
import microservice.auth_service.app.auth.core.application.events.UserRegisteredEvent;
import microservice.auth_service.app.auth.core.domain.event.user.UserCreatedEvent;
import microservice.auth_service.app.auth.core.domain.event.user.UserDeletedEvent;
import microservice.auth_service.app.auth.core.domain.event.user.UserUpdatedEvent;
