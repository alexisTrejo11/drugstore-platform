package microservice.auth_service.app.auth.adapter.output.grpc;
...
import microservice.auth_service.app.auth.core.domain.exceptions.UserNotFoundException;
import microservice.auth_service.app.auth.core.domain.exceptions.UserServiceAuthException;
