package io.github.alexisTrejo11.drugstore.users.app.user.core.domain.service;

import io.github.alexisTrejo11.drugstore.users.app.user.core.domain.exceptions.WeakPlainPasswordError;
...
public class PasswordValidator {
    ...
    public static void validatePasswordStrength(String password) {
        ...
        if (!matcher.matches()) {
            throw new WeakPlainPasswordError(
