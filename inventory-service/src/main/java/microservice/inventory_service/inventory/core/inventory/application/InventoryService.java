...
import microservice.inventory_service.inventory.core.inventory.application.cqrs.handler.command.CreateInventoryCommandHandler;
import microservice.inventory_service.inventory.core.batch.domain.entity.InventoryBatch;
import microservice.inventory_service.inventory.core.inventory.application.cqrs.handler.query.GetInventoryByIdQueryHandler;
import microservice.inventory_service.inventory.core.inventory.application.cqrs.handler.query.GetInventoryByProductQueryHandler;
...
import microservice.inventory_service.inventory.core.inventory.application.cqrs.handler.query.GetLowStockInventoriesQueryHandler;
import microservice.inventory_service.inventory.core.inventory.application.cqrs.query.GetInventoryByIdQuery;
import microservice.inventory_service.inventory.core.inventory.application.cqrs.query.GetInventoryByProductQuery;
