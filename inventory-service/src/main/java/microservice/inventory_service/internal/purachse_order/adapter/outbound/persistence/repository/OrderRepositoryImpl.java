...
public class OrderRepositoryImpl implements OrderRepository {
    private final EntityMapper<PurchaseOrderEntity, PurchaseOrder> mapper;
    private final JpaOrderRepository jpaRepository;

    @Override
    public PurchaseOrder save(PurchaseOrder PurchaseOrder) {
        PurchaseOrderEntity purchaseOrderEntity =  mapper.fromDomain(PurchaseOrder);
        PurchaseOrderEntity savedEntity = jpaRepository.save(purchaseOrderEntity);
