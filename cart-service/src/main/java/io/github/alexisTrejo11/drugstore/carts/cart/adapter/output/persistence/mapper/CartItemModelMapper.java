package io.github.alexisTrejo11.drugstore.carts.cart.adapter.output.persistence.mapper;
...
public class CartItemModelMapper {
   ...
   */
  public List<CartItemModel> toModels(List<CartItem> domainList) {
    if (domainList == null) {
   ...
   */
  public List<CartItem> toDomains(List<CartItemModel> models) {
    if (models == null) {
  ...
  public List<AfterwardsItem> toAfterwardsDomains(List<AfterwardModel> models) {
    if (models == null) {
  ...
  public List<AfterwardModel> toAfterwardsModels(List<AfterwardsItem> domainList) {
    if (domainList == null) {
