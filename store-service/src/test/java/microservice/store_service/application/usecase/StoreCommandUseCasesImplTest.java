...
import microservice.store_service.app.application.port.in.command.UpdateStoreNameAndContactCommand;
...
import microservice.store_service.app.application.usecase.StoreCommandUseCasesImpl;
...
class StoreCommandUseCasesImplTest {
    ...
    void updateStoreNameAndContactInfo_shouldUpdateAndSave() {
        ...
        var cmd = UpdateStoreNameAndContactCommand.builder()
                ...
                .infoCommand(new microservice.store_service.app.application.port.in.command.valueobject.ContactInfoCommand("123","a@b.com"))
                .build();
    ...
    void updateStoreLocation_shouldRelocateAndSave() {
        ...
        var geoCmd = new microservice.store_service.app.application.port.in.command.valueobject.GeolocationCommand(1.0,2.0);
        var addrCmd = microservice.store_service.app.application.port.in.command.valueobject.AddressCommand.builder()
    ...
    void activateStore_shouldActivateAndPublishEvent() {
        ...
        var cmd = new microservice.store_service.app.application.port.in.command.status.ActivateStoreCommand(id);
