...
public class SessionRepositoryImpl implements SessionRepository {
    ...
    private final RedisTemplate<String, Object> redisTemplate; // Cambiado a Object para flexibilidad
    ...
    public Session save(Session session) {
        try {
            ...
            String userSessionsKey = getUserSessionsKey(session.getUserId().toString());
