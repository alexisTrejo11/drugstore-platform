package io.github.alexisTrejo11.drugstore.inventories.order.sales.core.domain.entity;
...
import io.github.alexisTrejo11.drugstore.inventories.order.sales.core.domain.entity.valueobject.SalesOrderFullParams;
import io.github.alexisTrejo11.drugstore.inventories.order.sales.core.domain.entity.valueobject.*;
import io.github.alexisTrejo11.drugstore.inventories.order.sales.core.domain.exception.OrderStatusValidationException;
import io.github.alexisTrejo11.drugstore.inventories.order.sales.core.domain.exception.PurchaseOrderValidationException;
import io.github.alexisTrejo11.drugstore.inventories.shared.domain.order.BaseOrderDomain;
...
public class SaleOrder extends BaseOrderDomain<SaleOrderId> {
  ...
  public SaleOrder(SaleOrderId id, String paymentId, OrderStatus status, String notes, DeliveryMethod deliveryMethod,
      String customerUserId, String deliveryInfoId, String pickupInfoId, List<SalesOrderItem> items) {
  ...
  public SaleOrder updateOrderDetails(String notes, DeliveryMethod deliveryMethod, String deliveryInfoId,
      String pickupInfoId, List<SalesOrderItem> items) {
