package microservice.inventory_service.stock.domain;
...
import microservice.inventory_service.inventory.domain.exception.ReservationExpiredException;
...
public class StockReservation {
    ...
    public static class StockReservationReconstructor {
        ...
        public StockReservation reconstruct() {
            return new StockReservation(id, inventoryId, orderId, quantity, status,
