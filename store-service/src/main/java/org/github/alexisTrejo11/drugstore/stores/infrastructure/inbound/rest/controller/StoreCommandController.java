...
@Tag(name = "Store Command Operations", description = "Endpoints for creating, updating, and managing store entities. All operations require ADMIN role authentication.")
...
public class StoreCommandController {
  ...
  public ResponseEntity<ResponseWrapper<StoreID>> createStore(
      @CreateStoreBodyParameter @Valid @RequestBody @NotNull CreateStoreRequest request) {
