...
import microservice.auth.app.auth.core.domain.exceptions.UserNotFoundException;
import microservice.auth.app.auth.core.domain.exceptions.UserServiceAuthException;
import microservice.auth.app.auth.core.domain.exceptions.UserServiceException;
import microservice.auth.app.auth.core.domain.exceptions.UserServiceTimeoutException;
import microservice.auth.app.auth.core.domain.exceptions.UserServiceUnavailableException;
import microservice.auth.app.auth.core.ports.output.UserServiceClient;
import microservice.auth.grpc.generated.BoolResponse;
import microservice.auth.grpc.generated.EmailRequest;
import microservice.auth.grpc.generated.PhoneNumberRequest;
import microservice.auth.grpc.generated.UserIdRequest;
import microservice.auth.grpc.generated.UserResponse;
import microservice.auth.grpc.generated.UserServiceGrpc;
import microservice.auth.grpc.generated.ValidateUserCredentialsRequest;
import microservice.auth.grpc.generated.ValidateUserCredentialsResponse;
