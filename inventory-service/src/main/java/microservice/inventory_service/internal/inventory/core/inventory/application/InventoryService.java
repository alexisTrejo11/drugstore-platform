...
import microservice.inventory_service.internal.inventory.core.batch.application.handler.GetExpiringBatchesQueryHandler;
...
import microservice.inventory_service.internal.inventory.core.inventory.application.cqrs.handler.command.AdjustInventoryCommandHandler;
import microservice.inventory_service.internal.inventory.core.inventory.application.cqrs.handler.command.CreateInventoryCommandHandler;
import microservice.inventory_service.internal.inventory.core.batch.domain.entity.InventoryBatch;
import microservice.inventory_service.internal.inventory.core.inventory.application.cqrs.handler.query.GetInventoryByIdQueryHandler;
import microservice.inventory_service.internal.inventory.core.inventory.application.cqrs.handler.query.GetInventoryByProductQueryHandler;
import microservice.inventory_service.internal.inventory.core.inventory.application.cqrs.handler.query.GetInventoryMovementsQueryHandler;
import microservice.inventory_service.internal.inventory.core.inventory.application.cqrs.handler.query.GetLowStockInventoriesQueryHandler;
...
import microservice.inventory_service.internal.inventory.core.inventory.port.Input.InventoryUseCase;
