...
import microservice.inventory_service.inventory.infrastructure.adapter.outbound.persistence.model.InventoryAlertEntity;
...
@Component
public class InventoryAlertEntityMapper implements EntityMapper<InventoryAlertEntity, InventoryAlert> {
