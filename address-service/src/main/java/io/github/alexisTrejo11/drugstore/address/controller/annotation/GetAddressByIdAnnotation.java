...
@Operation(summary = "Get address by ID", description = "Retrieves a specific address by its ID for the authenticated user")
@ApiResponses(value = {
...
public @interface GetAddressByIdAnnotation {
}
